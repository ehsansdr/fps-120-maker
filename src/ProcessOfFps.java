public class ProcessOfFps implements Runnable{
    ...
    public void run() {//how thread would do and mange in this progeam
        ...
        //this variables have control the IFs in while(true) loop and manage the loop duration times
        ...
        while (true) {
            ...
            now = System.nanoTime();
            if (now - lastFrame >= timePerFrame) {//this "if" execute 120 per 1 sec based on this ("content")
                /**
